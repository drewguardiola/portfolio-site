...
export const projects = [
  {
    ...
    impact: "Manufactured rear wing used on the racecar, earning 23rd out of 86 teams at nationals.",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "A pipe made of two concentric layers of different materials under internal pressure. The radial stress plot shows the characteristic stress jump at the bimaterial interface, with the stiffer outer layer carrying a larger share of the hoop stress, while the inner layer takes most of the radial compression. Total deformation confirms the expected outward expansion with a discontinuity in radial slope at the interface, consistent with the analytical Lamé solution for compound cylinders.",
        images: [
  ...
  {
    id: "nasa-dragonfly-hover",
    title: "NASA Dragonfly Hover Analysis",
    category: "Engineering",
    featured: false,
    upcoming: true,
    priority: 11,
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Animated output of the simulation, showing the dice bouncing inside the moving cup with momentum-consistent impacts at the walls.",
        images: [
...

  {
    ...
    impact: "2nd of 100 at the SIG Chicago regional ($1,000) and 5th of 8,000 at the SIG national championship in Philadelphia ($1,500) in 2024–25.",
    role: "Player",
